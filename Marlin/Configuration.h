...
#define CUSTOM_MACHINE_NAME "Wean Kossel"
...
#define DELTA
  ...
  //#define DELTA_DIAGONAL_ROD 215.0 // mm 227-12 = 215
  #define DELTA_DIAGONAL_ROD 227.8 // mm 227-12 = 215                  ==========================================================================>

  // height from z=0 to home position
  //#define DELTA_HEIGHT 168.60 // get this value from auto calibrate
  //#define DELTA_HEIGHT 168.70
  #define DELTA_HEIGHT 169.30

  #define DELTA_ENDSTOP_ADJ { 0.8, -0.5, -3.8 } // get these from auto calibrate
  ...
  #define DELTA_RADIUS 110.5 //mm  Get this value from auto calibrate
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 100*1.1 }  // default steps per unit for Kossel (GT2, 20 tooth)
